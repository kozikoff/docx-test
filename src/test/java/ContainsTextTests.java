...
public class ContainsTextTests {
    ...
    void canAssertThatDocContainsText() throws IOException {
        ...
        assertThat(doc, containsText(new String[]{"Maecenas mauris lectus, lobortis et purus mattis, blandit dictum tellus.",
    ...
    void canAssertThatDocxContainsText() throws IOException {
        ...
        assertThat(docx, containsText(new String[]{"In non mauris justo. Duis vehicula mi vel mi pretium, a viverra " +
                "erat efficitur. Cras aliquam est ac eros varius, id iaculis dui auctor. Duis pretium neque ligula, " +
                "et pulvinar mi placerat et. Nulla nec nunc sit amet nunc posuere vestibulum. Ut id neque eget tortor " +
                "mattis tristique. Donec ante est, blandit sit amet tristique vel, lacinia pulvinar arcu. " +
                ...
                "Fusce vitae vestibulum velit. Pellentesque vulputate lectus quis pellentesque commodo. Aliquam erat " +
                        "wqvolutpat. Vestibulum in egestas velit. Pellentesque fermentum"}));
    }
}
